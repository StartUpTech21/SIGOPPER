<section class="headings">
        <div class="text-heading text-center">
            <div class="container" style="margin-top:-40px;">
                ...
                <h2><a href="index.php">Home </a> &nbsp;/&nbsp; Pusat Perbelanjaan</h2>
            </div>
        </div>
    </section>
    ...
    <section class="listings-full-grid featured popular portfolio blog">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-8">
                        <ul class="nav nav-tabs">
                          <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="?page=pengguna/pusat_perbelanjaan" style="color:green;">Tradisional</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="?page=pengguna/modern">Modern</a>
                          </li>
            ...
            <?php 
              ...
              $my = mysqli_query($koneksi, "SELECT * FROM tempat JOIN kategori USING(kode_kategori) JOIN galeri USING(kode_tempat) WHERE kategori.nama_kategori='Tradisional' GROUP BY tempat.kode_tempat ASC LIMIT $per_laman OFFSET $awal");
              ?>
